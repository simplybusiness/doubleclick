- view: user_campaign_facts
  ...
  sets:
    detail:
      - impression_funnel_user_id
      - impression_funnel_campaign_id
      - first_campaign_activity_date
      - first_campaign_click_date
      - first_campaign_impression_date
      - latest_campaign_click_date
      - latest_campaign_activity_date
      - latest_campaign_impression_date
