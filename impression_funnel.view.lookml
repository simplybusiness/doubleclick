- view: impression_funnel
  ...
  - dimension: latest_ad_impression
    type: time
    datatype: epoch
  ...
  - measure: count_users_who_clicked
    ...
    sql: ${user_id}
    filter: 
      first_ad_click_date: -NULL
  
  - measure: count_users_converted
    type: count_distinct 
    sql: ${user_id}
    filter: 
      first_ad_activity_date: -NULL
